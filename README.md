...
| `AI_API_KEY` | 智谱或阿里云 API Key |
| `AI_BASE_URL` | 智谱：`https://open.bigmodel.cn/api/paas/v4`；百炼：`https://dashscope.aliyuncs.com/compatible-mode/v1` |
| `AI_MODEL` | 智谱推荐 `glm-4-flash`；百炼推荐 `qwen-plus` |
